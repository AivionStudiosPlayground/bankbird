...
<nav class="bb-nav">
    <div class="bb-nav-inner">
        ...
        <div class="bb-nav-links">
            ...
            {{-- Updates dropdown: overzicht + technische details --}}
            <div class="bb-nav-dropdown">
                <button type="button" class="bb-nav-link bb-nav-dropdown-trigger @if(request()->is('updates') || request()->is('updates/*')) active @endif" aria-haspopup="true" aria-expanded="false" style="position:relative;">
                    Updates
                    <span style="position:absolute;top:-4px;right:-2px;background:#FF8A3D;color:white;font-size:0.5rem;font-weight:800;padding:0.1rem 0.35rem;border-radius:99px;text-transform:uppercase;letter-spacing:0.04em;">Nieuw</span>
                    <svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2" style="margin-left:0.25rem;transition:transform 0.2s;"><path stroke-linecap="round" stroke-linejoin="round" d="M3 4.5l3 3 3-3"/></svg>
                </button>
                <div class="bb-nav-dropdown-menu" role="menu">
                    <a href="{{ url('/updates') }}" class="bb-nav-dropdown-item @if(request()->is('updates')) active @endif" role="menuitem">
                        <span style="font-size:1rem;">✨</span>
                        <div>
                            <div style="font-weight:700;font-size:0.875rem;color:#0B1F3A;">Overzicht</div>
                            <div style="font-size:0.75rem;color:#6B7A99;">Wat er is en wat er aankomt</div>
                        </div>
                    </a>
                    <a href="{{ url('/updates/technisch') }}" class="bb-nav-dropdown-item @if(request()->is('updates/technisch')) active @endif" role="menuitem">
                        <span style="font-size:1rem;">⚙️</span>
                        <div>
                            <div style="font-weight:700;font-size:0.875rem;color:#0B1F3A;">Geavanceerde update</div>
                            <div style="font-size:0.75rem;color:#6B7A99;">Technische release-notes</div>
                        </div>
                    </a>
                </div>
            </div>
